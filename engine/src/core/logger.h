...
#include "defines.h" // For KAPI macro

#define LOG_WARN_ENABLED 1 // Enable warning logging by default.

#define LOG_INFO_ENABLED 1 // Enable info logging by default.

#define LOG_DEBUG_ENABLED 1 // Enable debug logging by default.

#define LOG_TRACE_ENABLED 1 // Enable trace logging by default.
